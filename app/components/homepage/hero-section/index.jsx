...
function HeroSection() {
  ...
  const codeLines = [
    ...
    `<span class="ml-4 lg:ml-8 mr-2 text-white">skills:</span><span class="text-gray-400">['</span><span class="text-amber-300">HTML & CSS</span><span class="text-gray-400">', '</span><span class="text-amber-300">Javascript</span><span class="text-gray-400">', </span> <span class="ml-4 lg:ml-8 mr-2 text-gray-400">'</span><span class="text-amber-300">ReactJS</span><span class="text-gray-400">', '</span><span class="text-amber-300">Redux</span><span class="text-gray-400">', '</span><span class="text-amber-300">NextJS</span><span class="text-gray-400">', '</span><span class="text-amber-300">MySql</span><span class="text-gray-400">',</span> <span class="ml-4 lg:ml-8 mr-2 text-gray-400">'</span><span class="text-amber-300">MongoDB</span><span class="text-gray-400">', '</span><span class="text-amber-300">Docker</span><span class="text-gray-400">', '</span><span class="text-amber-300">Git</span><span class="text-gray-400">', '</span><span class="text-amber-300">Firebase</span><span class="text-gray-400">'],</span>`,
