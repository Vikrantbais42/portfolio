...
function HeroSection() {
  ...
  const codeLines = [
    `<span class="mr-2 text-pink-500">const</span><span class="mr-2 text-white">developer</span><span class="mr-2 text-pink-500">=</span><span class="text-gray-400">${'{'}</span>`,
    `<span class="ml-4 lg:ml-8 mr-2 text-white">name:</span><span class="text-gray-400">'</span><span class="text-orange-400">Vikrant Bais</span><span class="text-gray-400">',</span>`,
    `<span class="ml-4 lg:ml-8 mr-2 text-white">skills:</span><span class="text-gray-400">['</span><span class="text-amber-300">HTML & CSS</span><span class="text-gray-400">', '</span><span class="text-amber-300">Javascript</span><span class="text-gray-400">', </span> <span class="ml-4 lg:ml-8 mr-2 text-gray-400">'</span><span class="text-amber-300">React.js</span><span class="text-gray-400">', '</span><span class="text-amber-300">php</span><span class="text-gray-400">', '</span><span class="text-amber-300">Node.js</span><span class="text-gray-400">', '</span><span class="text-amber-300">Laravel</span><span class="text-gray-400">',</span> <span class="ml-4 lg:ml-8 mr-2 text-gray-400"><span class="text-gray-400">'</span></span><span class="text-amber-300">MySql & MongoDB</span><span class="text-gray-400">', '</span><span class="text-amber-300">Docker</span><span class="text-gray-400">', '</span><span class="text-amber-300">Git</span><span class="text-gray-400">', </span><span class="text-gray-400 ml-8">'</span><span  class="text-amber-300">Firebase</span><span class="text-gray-400">'],</span>`,
  ...
  return (
    <section  className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div data-aos="zoom-in-up" className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
